...
//      }
    ...
    private List<String> getGroup(Claims claims) {
...
//		    String jwt = generateTokenFromUsername(userPrincipal.getUsername());
		    ...
		    ResponseCookie cookie = ResponseCookie.from("suman_coder", jwt).path("/api/").maxAge(24 * 60 * 60).httpOnly(true).build();
		    return cookie;
		  }
//		  
//
		  public ResponseCookie getCleanJwtCookie() {
		    ...
		    ResponseCookie cookie = ResponseCookie.from("suman_coder", null).path("/api/").maxAge(0).build();
		    System.out.println("Expried "+ cookie.getMaxAge().getSeconds());
		    return cookie;
		  }
//
