...
//url- http://localhost:8080/api/payload
public class PayloadController {
	...
	//url- http://localhost:8080/innspark/payload/delete/
	@DeleteMapping("/deletepayload/{id}")
	public ResponseEntity<String> deletepayload(@PathVariable("id") String id){
