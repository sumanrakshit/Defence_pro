...
//    permit all url (/api/**) and add session create STATELESS  
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().cors().disable()
                ...
                .requestMatchers("/v1/login_user").permitAll()
                .requestMatchers("/v1/users").permitAll()
//                .requestMatchers("v1/templates").permitAll()
                .requestMatchers("/v1/logout_user").permitAll()
                .anyRequest().authenticated()
