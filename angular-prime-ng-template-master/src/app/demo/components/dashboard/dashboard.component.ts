...
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    constructor(private productService: ProductService, public layoutService: LayoutService,private templateService: TemplateService,public _sanitizer: DomSanitizer) {
